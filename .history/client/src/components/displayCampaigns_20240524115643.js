        ...
        <div>
            {campaigns.map((campaign, index) => (
                <div key={index}>
                    ...
                    <p>Target: {ethers.utils.formatUnits(campaign.target, "ether")} ETH</p>
                    <p>Collected: {ethers.utils.formatUnits(campaign.amountCollected, "ether")} ETH</p>
                    <p>Deadline: {new Date(campaign.deadline * 1000).toLocaleString
