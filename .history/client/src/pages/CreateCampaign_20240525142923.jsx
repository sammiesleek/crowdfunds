  ...
  const handleSubmit = async (e) => {
    ...
    checkIfImage(form.image, async (exists) => {
      if (exists) {
        ...
        console.log(Math.floor(new Date(form.deadline).getTime() / 1000));
        // const deadlineTimestamp = Math.floor(
        //   new Date(_deadline).getTime() / 1000
        // );

        // console.log(formatEtherValue(ethers.utils.parseUnits(form.target, 18)));
        try {
